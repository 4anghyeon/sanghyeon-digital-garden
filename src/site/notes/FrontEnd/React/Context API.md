...
![Pasted image 20231108115631.png](/img/user/Pasted%20image%2020231108115631.png)

즉, 깊이가 깊어질수록 `props`가 어느 컴포넌트에서 왔는지 파악하기 힘들어지고, 관리와 오류 대응이 늦어진다.
# Context API

![Pasted image 20231108122811.png](/img/user/Pasted%20image%2020231108122811.png)
