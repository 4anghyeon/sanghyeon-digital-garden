---
{"dg-publish":true,"permalink":"//data-structure/string/","noteIcon":"","created":"","updated":""}
---

![string thumbnail.png](/img/user/%EA%B0%9C%EB%B0%9C/Data%20Structure/string%20thumbnail.png)
# 문자열 (String)
문자열은 문자들의 집합, 배열로서 엄밀하게 자료 구조라고 볼 수 없지만 [[개발/Data Structure/배열 (Array)\|배열 (Array)]]과 유사하기 때문에 자료 구조의 하위 항목으로 묶었다.
